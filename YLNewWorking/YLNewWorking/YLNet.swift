...
class YLNet: NSObject {
    ...
    /**
        ...
        fail   :  失败的闭包回调
     */
    class func request(method : String = "GET", url:String, form:[String : AnyObject], success:((data : NSData?)->())?, fail:((err:NSError?)->())?){
            var innerUrl = url
        if method == "GET"{
    ...
    class func buildParams(params:[String:AnyObject]) -> String{
